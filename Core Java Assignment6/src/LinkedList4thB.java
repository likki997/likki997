	...
	Date1 d4=new Date1(23,12,2001); l.add(d1);
	l.add(d2);
	l.add(d3);
	l.add(d4); System.out.println("\n\nBefore reversing :");
	for(Date1 d:l) {
	System.out.println("\nDate: "+d.date+"-"+d.month+"-"+d.year);
	System.out.println("Leap Year:"+d.leapYear()); }
	Collections.reverse(l);
	System.out.println("\n\nAfter reversing :"); for(Date1 b:l) {
	System.out.println(""+"\nDate: "+b.date+"-"+b.month+"-"+b.year); } } }
	class Date1{ int date,month,year;
